...
router.get(
    "/usersnotcollaborators/:activityId",
    activityController.getUsersNotCollaborators
);
router.get("/search/:clubId/:searchValue", activityController.search);
router.get(
    "/searchcollaborators/:activityId/:searchValue",
    activityController.searchCollaborators
);
router.get(
    "/searchusersnotcollaborators/:activityId/:searchValue",
    activityController.searchUsersNotCollaborators
);
